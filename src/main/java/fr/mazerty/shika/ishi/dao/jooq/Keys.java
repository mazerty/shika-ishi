...
public class Keys {
    ...
    private static class ForeignKeys0 extends AbstractKeys {
        public static final ForeignKey<TUserApplicationRecord, TUserRecord> T_USER_APPLICATION__T_USER_APPLICATION_USER_FK_FKEY = createForeignKey(fr.mazerty.shika.ishi.dao.jooq.Keys.T_USER_PKEY, TUserApplication.T_USER_APPLICATION, "t_user_application__t_user_application_user_fk_fkey", TUserApplication.T_USER_APPLICATION.USER_FK);
        public static final ForeignKey<TUserApplicationRecord, TApplicationRecord> T_USER_APPLICATION__T_USER_APPLICATION_APPLICATION_FK_FKEY = createForeignKey(fr.mazerty.shika.ishi.dao.jooq.Keys.T_APPLICATION_PKEY, TUserApplication.T_USER_APPLICATION, "t_user_application__t_user_application_application_fk_fkey", TUserApplication.T_USER_APPLICATION.APPLICATION_FK);
    }
}
